...
function(cpptest_add_executable TARGET)
  ...
  set(BDF ${CMAKE_CURRENT_BINARY_DIR}/${CPPTEST_PROJECT_NAME}.bdf)
  set(RUN_ORIG_CMD "no")
  set(OPTSCAN_NAME ${CPPTEST_PROJECT_NAME}_scan.sh)

  configure_file(
    ${_THIS_MODULE_TEMPLATES_DIR}/cpptestscan.in
  ...
  if(_CPPTEST_PROJECT_FOLDERS)
    foreach(f ${_CPPTEST_PROJECT_FOLDERS})
      ...
      list(GET fSemi 0 LINK_NAME)
      list(GET fSemi 1 LINK_TARGET)
      
      configure_file(
        ${_THIS_MODULE_TEMPLATES_DIR}/linked_folder.in
        ${CMAKE_CURRENT_BINARY_DIR}/${LINK_NAME}.linked_folder @ONLY
        NEWLINE_STYLE UNIX)
      file(STRINGS ${CMAKE_CURRENT_BINARY_DIR}/${LINK_NAME}.linked_folder fLinked)
      string(APPEND CPPTEST_LINKED_FOLDERS "\n" ${fLinked})
      
      file(MAKE_DIRECTORY ${LINK_TARGET})
    endforeach()
  endif()
  ...
  # set up cleaning generated BDF file
  # since cmake 3.15
  set_target_properties(${TARGET} PROPERTIES
